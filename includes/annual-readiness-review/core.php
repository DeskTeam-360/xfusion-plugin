...
if (root) {
    ...
    var goTo = function (i) {
        ...
        if (target > current && typeof window.xarrSaveDraft === 'function') {
            try { window.xarrSaveDraft(); } catch (e) {}
        }
        goToInner(target);
    };
    ...
    var xarrResumeIndex = function () {
        var progress = (window.XFARR_WIZARD && window.XFARR_WIZARD.stepProgress) || {};
        var furthest = -1;
