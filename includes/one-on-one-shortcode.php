...
@media (min-width:1440px){
    #xfusion-oo-app{max-width:1440px;display:grid;grid-template-columns:560px 1fr;gap:1.25rem;align-items:start}
...
#xfusion-oo-app button.xfoo-btn.secondary,
#xfusion-oo-app a.xfoo-btn.secondary{background:#fff !important;color:#2563eb !important}
#xfusion-oo-app button.xfoo-btn.danger,
#xfusion-oo-app a.xfoo-btn.danger{border-color:#dc2626 !important;background:#dc2626 !important}
#xfusion-oo-app button.xfoo-btn.success,
#xfusion-oo-app a.xfoo-btn.success{border-color:#16a34a !important;background:#16a34a !important}
#xfusion-oo-app button.xfoo-btn:disabled{opacity:.5;cursor:default}
#xfusion-oo-app button.xfoo-btn.xs,
#xfusion-oo-app a.xfoo-btn.xs{padding:.15rem .5rem !important;font-size:.72rem !important}
