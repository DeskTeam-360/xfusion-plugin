...
/* Loading state */
.xqbr-spinner-row{display:flex;align-items:center;gap:.6rem;padding:.75rem 0;color:var(--muted);font-size:16px}
.xqbr-spinner{width:18px;height:18px;border:2px solid var(--border);border-top-color:var(--green);border-radius:50%;display:inline-block;animation:xqbr-spin .7s linear infinite;flex-shrink:0}
.xqbr-spinner-inline{width:14px;height:14px;vertical-align:-2px;margin-right:.15rem}
@keyframes xqbr-spin{to{transform:rotate(360deg)}}
.xqbr-loading-stack{display:flex;flex-direction:column;gap:.35rem}
.xqbr-skeleton-list{opacity:.92}
.xqbr-skeleton-card{pointer-events:none;border-color:#eef0f3;background:linear-gradient(90deg,#fafafa 0%,#f3f4f6 50%,#fafafa 100%);background-size:200% 100%;animation:xqbr-shimmer 1.4s ease-in-out infinite}
.xqbr-skeleton-card .xqbr-skeleton-circle{width:30px;height:30px;border-radius:50%;background:#e5e7eb;color:transparent;flex-shrink:0}
.xqbr-skeleton-line{height:12px;border-radius:999px;background:linear-gradient(90deg,#eceff3 0%,#f8f9fb 50%,#eceff3 100%);background-size:200% 100%;animation:xqbr-shimmer 1.4s ease-in-out infinite;margin-bottom:.55rem}
.xqbr-skeleton-line:last-child{margin-bottom:0}
.xqbr-skeleton-line.w-full{width:100%}
.xqbr-skeleton-line.w-95{width:95%}
.xqbr-skeleton-line.w-90{width:90%}
.xqbr-skeleton-line.w-80{width:80%}
.xqbr-skeleton-line.w-75{width:75%}
.xqbr-skeleton-line.w-70{width:70%}
.xqbr-skeleton-line.w-65{width:65%}
.xqbr-skeleton-line.w-60{width:60%}
.xqbr-skeleton-line.w-55{width:55%}
.xqbr-skeleton-line.w-50{width:50%}
.xqbr-skeleton-line.w-45{width:45%}
.xqbr-skeleton-line.w-40{width:40%}
.xqbr-skeleton-line.w-35{width:35%}
.xqbr-skeleton-line.w-20{width:20%}
.xqbr-skeleton-stats .xqbr-skeleton-line{height:14px;margin-bottom:.7rem}
@keyframes xqbr-shimmer{0%{background-position:200% 0}100%{background-position:-200% 0}}
.xqbr-main-loading{position:relative;min-height:120px}
.xqbr-main-loading::after{content:'';position:absolute;inset:0;background:rgba(255,255,255,.55);z-index:2;pointer-events:none}
.xqbr-main-loading .xqbr-step-loading-bar{position:absolute;top:0;left:0;right:0;height:3px;z-index:3;background:linear-gradient(90deg,transparent,var(--green),transparent);background-size:200% 100%;animation:xqbr-shimmer 1s linear infinite}
...
.xqbr-badge.gray{background:#f3f4f6;color:#374151}
...
.xqbr-prio-grid-3{grid-template-columns:repeat(3,minmax(0,1fr))}
...
.xqbr-review-head{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;margin-bottom:.75rem;padding-bottom:.85rem;border-bottom:1px solid var(--border)}
.xqbr-review-head h3{margin:0 0 .15rem;font-size:18px}
.xqbr-review-head .xqbr-muted{margin:0;font-size:13px}
.xqbr-review-quarter{flex-shrink:0;color:var(--muted);font-size:13px;font-weight:700;white-space:nowrap;margin-top:.15rem}
.xqbr-review-list{display:flex;flex-direction:column}
.xqbr-review-row{display:flex;align-items:center;gap:.9rem;padding:.9rem 0;border-bottom:1px solid var(--border);width:100%;text-align:left;background:transparent!important;border-left:none;border-right:none;border-top:none;font:inherit;color:inherit}
.xqbr-review-row-link{cursor:pointer;border-radius:.5rem;margin:0 -.5rem;padding-left:.5rem;padding-right:.5rem;transition:background .15s ease}
.xqbr-review-row-link:hover{background:#f8fafc}
.xqbr-review-row-link:focus-visible{outline:2px solid var(--green);outline-offset:2px}
.xqbr-review-row:last-child{border-bottom:none;padding-bottom:.25rem}
.xqbr-review-row:first-child{padding-top:.25rem}
.xqbr-review-icon{width:60px;height:60px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0}
.xqbr-review-icon img{width:60px;height:60px;object-fit:contain;display:block}
.xqbr-review-body{min-width:0;flex:1}
.xqbr-review-body strong{display:block;color:var(--navy);font-size:20px;font-weight:700;text-transform:none;}
.xqbr-review-desc{margin:.15rem 0 0;color:var(--muted);font-size:18px;line-height:1.4;text-transform:none;}
.xqbr-review-right{flex-shrink:0;display:flex;flex-direction:column;align-items:flex-end;gap:.25rem}
.xqbr-review-badge{display:inline-flex;align-items:center;gap:.35rem;font-size:16px;font-weight:700}
.xqbr-review-badge.done{color:#16a34a}
.xqbr-review-badge.pending{color:#d97706}
.xqbr-review-check{width:20px;height:20px;border-radius:50%;background:#e9f5e1;display:inline-flex;align-items:center;justify-content:center;font-weight:700;font-size:.7rem;flex-shrink:0}
.xqbr-review-badge.pending .xqbr-review-check{background:#fef3e2}
.xqbr-review-step{color:var(--muted);font-size:14px}
...
.xqbr-doc-preview{display:flex;gap:.85rem;align-items:flex-start;margin-bottom:1rem}
.xqbr-doc-preview-icon{width:50px;height:50px;flex-shrink:0;display:block;object-fit:contain;margin-top:.1rem}
.xqbr-doc-preview-body{min-width:0;flex:1}
.xqbr-doc-preview-title{margin:0 0 .25rem;font-size:16px!important;font-weight:700;color:var(--navy);text-transform:none;letter-spacing:0;line-height:1.3}
.xqbr-doc-preview-body .xqbr-muted{margin:0}
...
.xqbr-guide-card h4 img{width:auto;height:50px;object-fit:contain;flex-shrink:0;display:block}
...
.xqbr-heading-with-icon img{width:auto;height:50px;object-fit:contain;flex-shrink:0;display:block}
...
.xqbr-prio-grid-3{grid-template-columns:repeat(2,minmax(0,1fr))}
...
.xqbr-prio-grid-3{grid-template-columns:1fr}
