        ...
        if (arps.length === 0) {
            ...
            arps.forEach(function (a) {
                ...
                html += '<tr><td>' + escHtml(a.company_name) + '</td><td>' + escHtml(a.year) + '</td>' +
                    ...
                    '<td>' + accessBadge + '</td>' +
                    '<td><button type="button" class="xar-badge green xar-picker-open-btn" data-open="' + a.id + '">Open</button></td></tr>';
            });
